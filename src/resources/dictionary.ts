...
export const dictionaryResources: DictionaryResource[] = [
    ...
    id: 'x-ui',
    name: 'X 界面常用词',
    description: 'X(Twitter)网页/移动端界面常用按钮与导航词',
    category: '软件英语',
    tags: ['界面'],
    url: '/dicts/x-ui.json',
    length: 76,
  ...
  },
  {
    id: 'apple-ui',
    name: 'Apple 界面常用词',
    description: 'iOS/macOS 系统界面常用按钮、菜单、设置项',
    category: '软件英语',
    tags: ['界面'],
    url: '/dicts/apple-ui.json',
    length: 96,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'claude-ui',
    name: 'Claude 界面常用词',
    description: 'Claude.ai 网页界面常用按钮、菜单、概念词',
    category: '软件英语',
    tags: ['界面'],
    url: '/dicts/claude-ui.json',
    length: 101,
    language: 'en',
    languageCategory: 'en',
  },
  {
        id: 'github-ui',
        name: 'GitHub 界面常用词',
        description: 'GitHub 仓库、PR、Issue、Actions 等界面常用词',
        category: '软件英语',
        tags: ['界面'],
        url: '/dicts/github-ui.json',
        length: 88,
        language: 'en',
        languageCategory: 'en',
  },
  {
    id: 'phonetic-mvp',
    name: '英语音标速成 - 48音 minimal pairs',
    description: '按 i+1 难度梯度排序,20 章×8 词 minimal pairs 训练',
    category: '软件英语',
    tags: ['音标'],
    url: '/dicts/phonetic-mvp.json',
    length: 160,
    language: 'en',
    languageCategory: 'en',
  },
